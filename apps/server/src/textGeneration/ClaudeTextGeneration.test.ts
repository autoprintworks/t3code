...
it.layer(ClaudeTextGenerationTestLayer)("ClaudeTextGeneration", (it) => {
  ...
  posixOnly("forwards Claude thinking settings without passing unsupported effort", () =>
    withFakeClaudeEnv(
      {
  ...
  posixOnly("keeps a configured custom alias opaque to the Claude CLI", () =>
    withFakeClaudeEnv(
      {
        output: JSON.stringify({
          structured_output: {
  ...
  posixOnly("generates branch names from skill prompts without executable capabilities", () =>
    withFakeClaudeEnv(
      {
