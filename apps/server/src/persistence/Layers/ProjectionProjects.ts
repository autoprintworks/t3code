    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.title},
          ${row.workspaceRoot},
          ${row.repositoryIdentity !== null ? JSON.stringify(row.repositoryIdentity) : null},
          ${row.repositoryIdentityWorkspaceRoot},
        ...
        DO UPDATE SET
          ...
          repository_identity_workspace_root = excluded.repository_identity_workspace_root,
