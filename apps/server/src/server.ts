...
import { RepositoryIdentityReactorLive } from "./orchestration/Layers/RepositoryIdentityReactor.ts";
...
import * as LoopIntegrityGuard from "./diagnostics/LoopIntegrityGuard.ts";
...
const ReactorLayerLive = Layer.empty.pipe(
  ...
  Layer.provideMerge(RepositoryIdentityReactorLive),
...
const RuntimeDependenciesLive = RuntimeCoreDependenciesLive.pipe(
  ...
  Layer.provideMerge(LoopIntegrityGuard.layer),
