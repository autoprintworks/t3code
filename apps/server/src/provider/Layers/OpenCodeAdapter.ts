...
export function makeOpenCodeAdapter(
  ...
  return Effect.gen(function* () {
     ...
     * starts its process through `connectToOpenCodeServer`, which takes the provider
     ...
     * handing it to `connectToOpenCodeServer`. That function owns the merge and the PATH
