...
// The ACP agent these tests stand in for is a POSIX shell script, which Windows cannot execute.
const skipPosixShellStub = process.platform === "win32";

it.layer(grokAdapterTestLayer)("GrokAdapterLive", (it) => {
  it.effect.skipIf(skipPosixShellStub)(
    "starts a session and maps mock ACP prompt flow to runtime events",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)("closes the ACP child process when a session stops", () =>
    Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "reports a Grok session running only while the prompt is in flight",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "restores ready without completing an unstarted turn when preparation fails",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "completes a Grok turn from xAI prompt completion when the prompt RPC hangs",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "retains turn transcript when sendTurn is interrupted after prompt success",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "does not report a synthetic stop reason when xAI omits one",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "lets Stop unblock a fully silent Grok prompt and accept a follow-up turn",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "does not let a cancelled prompt settlement consume the follow-up prompt slot",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "drops late ACP notifications after a turn is cancelled",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "lets Stop cancel during the xAI completion drain window",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "settles the in-flight prompt before emitting completion",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "restores a Grok session to ready when the prompt RPC fails",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "ignores replayed session/load updates when resuming a Grok session",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)("rejects sendTurn with empty input and no attachments", () =>
    Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "responds to ACP approvals using provider-supplied option ids",
    () =>
      Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)("handles xAI ask_user_question extension requests", () =>
    Effect.gen(function* () {
  ...
  it.effect.skipIf(skipPosixShellStub)(
    "continues streaming events when native notification logging fails",
    () =>
      Effect.gen(function* () {
