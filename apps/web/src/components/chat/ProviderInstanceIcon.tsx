...
import { providerInstanceIcon } from "./providerIconUtils";
...
export const ProviderInstanceIcon = memo(function ProviderInstanceIcon(props: {
  ...
  displayName: string;
  /** Glyph the instance's own snapshot asked for, when its driver has none. */
  ...
  const Icon = providerInstanceIcon({ driverKind: props.driverKind, iconKey: props.iconKey });
